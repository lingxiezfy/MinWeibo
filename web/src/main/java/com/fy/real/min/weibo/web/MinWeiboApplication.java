...
public class MinWeiboApplication {
	...
	public SqlSessionFactory hkOrderSqlSessionFactory(@Qualifier("druidDataSource") DataSource dataSource) throws Exception {
		...
		bean.setTypeAliasesPackage(MinWeiboApplication.MODEL_PACKAGE);
		bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources(MinWeiboApplication.MAPPER_LOCATION));
